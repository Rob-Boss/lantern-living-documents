# Google Ads Copywriting Assets & Creative Guide

This document tracks and organizes copywriting assets for the Lantern Camp Google Search campaigns. All assets are formatted to fit Google's strict character limits:
*   **Headlines:** Maximum **30 characters**
*   **Descriptions:** Maximum **90 characters**

---

## 1. Ad Group 1: Brand Protection
**Target Audience:** Users explicitly searching for "Lantern Camp".
**Goal:** Capture high-intent brand traffic, highlight direct booking benefits, and establish the brand's unique design and nature positioning.

### Headlines (Choose up to 15)
*Keep a mix of brand anchors, direct booking calls to action, and your creative hooks.*
...
| `Grown-Ups Love Camp, Too` | 24 | Creative (Kids at Camp) |
| `Take All The Time You Need` | 26 | Creative (Pace) |
| `A Different Kind of Camp` | 24 | Creative (Differentiation) |
| `This Is Not A Hotel` | 19 | Creative (Landscape Hotel) |
| `Not Like Other Hotels` | 21 | Creative (Landscape Hotel) |
| `Actually, You Can Have It All` | 29 | Creative (Harmony) |
| `Like Vacation, But Peaceful` | 27 | Creative (Serenity) |
...
### Headlines (Choose up to 15)
*Must include literal search terms to guarantee high Quality Scores and Click-Through Rates.*
...
### Sitelinks
*Provide direct links to specific pages/sections of the site.*

1.  **Sitelink 1: Our Cabins** (24 Chars)
...
2.  **Sitelink 2: Book Direct & Save** (25 Chars)
...
3.  **Sitelink 3: View the Gallery** (20 Chars)
...
4.  **Sitelink 4: Explore Mid-Coast Maine** (28 Chars)
    ...
    *   *Final URL:* `https://www.lanterncamp.com/explore`

### Callouts (25 Characters max)
*Short, bulleted highlights of key amenities and differentiators.*

*   `100-Mile Views` (14 chars)
*   `Modern Design` (13 chars)
*   `Bypass OTA Fees` (15 chars)
*   `Near Acadia ME` (14 chars)
*   `Fully Equipped` (14 chars)
*   `Dog Friendly Options` (20 chars)
*   `Cedarwood Sauna` (15 chars)
*   `Guided Stargazing` (17 chars)

### Structured Snippets
*Predefined categories to list features.*

*   **Amenities:** `Kitchenette`, `Custom Windows`, `Mountain Views`, `Sauna`, `Forest Trails`
