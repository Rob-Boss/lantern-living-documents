# ✍️ PR Writing & Formatting Guide

A practical reference for writing press releases, drafting pitches, and formatting deliverables to make them frictionless for journalists.
...
*   **End Marker:** Place centered `# # #` or `###` at the bottom to signal the end of the release.
